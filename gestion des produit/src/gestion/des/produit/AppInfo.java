...
public class AppInfo extends javax.swing.JFrame {
 ...
 void icon(){
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        String s="Cette application est réalisée par Mohamed Majdi Ben Aoune et Mohamed Aymen Zairi\n" +
"elle aide le vendeur d'organiser, faire la gestion de ces produits  et faciliter l’interaction avec toutes les acteurs concernant les articles pour meilleur \nrentabilité  et bon décision .\n" +
"Email :majdi.benaoune@gmail.com " + " MedaymenZairi@gmail.com" ;
