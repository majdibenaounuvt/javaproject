...
public class Forniseur_Client extends javax.swing.JFrame {
   ...
   icon();
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Ariana", "Béja", "Ben Arouss" ,"Bizerte","Gabes","Gafsa","Jandouba","Kairouan","Kasserine","Kebili","Kef","Mahdia","Manouba","Mednine","Monastir","Nabeul","Sfax","Sidi Bouzid","Siliane","Sousse","Tataouine","Tozeur","Tunis","Zaghouan" }));
